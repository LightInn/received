...
export default function StoryHeader({storyData, userData, handleReadChapter, handleLogin}: StoryHeaderProps) {
    ...
    return (
        <Card className="mb-8">
            ...
            <CardContent>
                ...
                {userData.isLoggedIn && (
                    <StoryProgress currentChapter={userData.currentChapter} totalChapters={storyData.chapters}/>
                )}
            </CardContent>
            <CardFooter className="flex justify-between">
                ...
                <div className="flex justify-between my-4">
                    <Button onClick={() => handleReadChapter(userData.isLoggedIn ? userData.currentChapter : 1)}>
