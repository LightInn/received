    ...
    return (
        <nav className="flex items-center justify-between px-4 py-2 border-b">
            <div className="flex items-center gap-6">
                ...
                <DropdownMenu>
                    <DropdownMenuTrigger className="text-sm font-medium">Community</DropdownMenuTrigger>
                    <DropdownMenuContent>
            ...
            <div className="flex-1 max-w-xl mx-4">
                <div className="relative">
                    ...
                    <input type="search" placeholder="Search" className="w-full pl-8 pr-4 py-2 rounded-md border bg-background" />
                </div>
            </div>

            <div className="flex items-center gap-4">
                <DropdownMenu>
                    <DropdownMenuTrigger className="text-sm font-medium">Write</DropdownMenuTrigger>
                    <DropdownMenuContent>
