...
const creatorStories = [
  { id: 1, title: "The Last Message", views: 15000, chapters: 5, status: "published" },
  { id: 2, title: "Whispers in the Chat", views: 12000, chapters: 3, status: "draft" },
  { id: 3, title: "Digital Love Letters", views: 8000, chapters: 7, status: "published" },
]
...
export function CreatorDashboardComponent() {
        ...
        <TabsContent value="stories">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Manage and track your created stories</CardDescription>
            </CardHeader>
            <CardContent>
              <ScrollArea className="h-[400px] w-full">
                {stories.map(story => (
                  <div key={story.id} className="flex items-center justify-between p-4 border-b last:border-b-0">
                    <div>
        ...
        <TabsContent value="create">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Start a new story and bring your ideas to life</CardDescription>
            </CardHeader>
            <CardContent>
